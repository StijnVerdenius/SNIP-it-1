...
class SNAP(General):
    ...
    def handle_pruning(self, all_scores, grads_abs, norm_factor, percentage):
        ...
        for ((identification, name), grad), (first, last) in lookahead_finished(grads_abs.items()):
            ...
            # first and last layers are handled differently
            if first or last:
