...
class SNIP(General):
    ...
    """
    Our interpretation/implementation of SNIP from their paper:
    SNIP: Single-shot Network Pruning based on Connection Sensitivity
    Additionally, edited to use elasticity as a criterion instead of sensitivity, which we explain in our paper
    Implementation is loosely based on a public github by mi-lad
    """
