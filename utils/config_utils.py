...
"""
handles configurable arguments
"""
...
def parse() -> argparse.Namespace:
    ...
    parser.add_argument('--snip_steps', default=5, type=int,
                        help="'s' in algorithm box, number of pruning steps for 'rule of thumb' ")
    ...
    parser.add_argument('--checkpoint_name', default=None
                        , type=str,
                        help='load from this identification for run (foldernames in results folder). If None, then nothing is loaded')
